...
func (s *FailoverState) HandleFailoverError(
	...
	failoverErr, sameAccountRetryLimit := resolveFailoverArguments(args...)
...
// resolveFailoverArguments accepts both historical argument orders:
//
//   - (failoverErr [, retryLimit])
//   - (retryLimit, failoverErr)
//
// The compatibility layer is intentionally contained here so callers can be
// migrated independently without changing failover behavior.
func resolveFailoverArguments(args ...any) (*service.UpstreamFailoverError, int) {
