...
func (s *sparkShadowRepoStub) ListWithFilters(_ context.Context, _ pagination.PaginationParams, _, _, _, _, _ string, _, _ int64, _ string) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
