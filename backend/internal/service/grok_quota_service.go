...
// constructor above remains source-compatible for lightweight tests and
// integrations that do not need the global URL policy.
func NewGrokQuotaServiceWithConfig(
	accountRepo AccountRepository,
	proxyRepo ProxyRepository,
	tokenProvider *GrokTokenProvider,
	httpUpstream HTTPUpstream,
