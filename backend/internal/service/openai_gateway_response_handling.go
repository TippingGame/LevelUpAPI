...
func openAIUsageFromGJSON(value gjson.Result) (OpenAIUsage, bool) {
	...
	textInputTokens := firstPositiveGJSONInt(
		value.Get("input_tokens_details.text_tokens"),
		value.Get("prompt_tokens_details.text_tokens"),
	)
	textOutputTokens := firstPositiveGJSONInt(
		value.Get("output_tokens_details.text_tokens"),
		value.Get("completion_tokens_details.text_tokens"),
	)
	textCacheReadTokens := firstPositiveGJSONInt(
		value.Get("input_tokens_details.cached_text_tokens"),
		value.Get("prompt_tokens_details.cached_text_tokens"),
	)
	imageCacheReadTokens := firstPositiveGJSONInt(
		value.Get("input_tokens_details.cached_image_tokens"),
		value.Get("prompt_tokens_details.cached_image_tokens"),
	)
	return OpenAIUsage{
		...
		TextCacheReadInputTokens:  textCacheReadTokens,
		ImageCacheReadInputTokens: imageCacheReadTokens,
