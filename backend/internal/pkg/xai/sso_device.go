...
// ConvertSSOToBuild exchanges a Grok Web SSO cookie for official xAI Build
// OAuth credentials by completing the xAI Device Flow server-side.
...
// NormalizeSSOToken accepts a raw SSO value or a Cookie header and returns
// only the sso/sso-rw value, stripped of control characters.
