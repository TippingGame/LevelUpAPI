...
// ReadLenientJSONRequestBodyWithPrealloc reads and normalizes JSON produced by
// clients that put raw control bytes inside string values. Structural JSON
// errors remain errors for the normal strict parser later in the request path.
...
// strings and removes a leading UTF-8 BOM. It deliberately does not repair
