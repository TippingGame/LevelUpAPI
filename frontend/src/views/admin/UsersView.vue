          ...
          <template #cell-usage="{ row }">
            <div class="text-sm">
              <div class="flex items-center gap-1.5">
                ...
                <span class="font-medium text-gray-900 dark:text-white">
                  {{ formatGameCoins(usageStats[row.id]?.today_actual_cost ?? 0, { minimumFractionDigits: 4, maximumFractionDigits: 4 }) }}
                </span>
              </div>
              <div class="mt-0.5 flex items-center gap-1.5">
                <span class="text-gray-500 dark:text-gray-400">{{ t('admin.users.total') }}:</span>
                <span class="font-medium text-gray-900 dark:text-white">
                  {{ formatGameCoins(usageStats[row.id]?.total_actual_cost ?? 0, { minimumFractionDigits: 4, maximumFractionDigits: 4 }) }}
                </span>
              </div>
            </div>
          </template>
