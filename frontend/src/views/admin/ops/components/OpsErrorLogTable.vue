            ...
            >
              ...
              <td class="px-4 py-2">
                <div v-if="log.api_key_id || log.api_key_name" class="flex max-w-[140px] items-center gap-1">
                  ...
                  <span v-if="log.api_key_deleted" class="flex-shrink-0 rounded bg-red-50 px-1 py-0.5 text-[9px] font-bold text-red-700 ring-1 ring-inset ring-red-600/20 dark:bg-red-900/30 dark:text-red-400 dark:ring-red-500/30">
