...
describe('admin order currency display', () => {
  it('uses order currency for paid/base/fee amounts and game coins for credited/refund amounts', () => {
    ...
    expect(text).toContain('100.00 coins')
    expect(text).toContain('25.00 coins')
  })

  it('uses order currency for pay_amount and game coins for refundable balance amounts', () => {
    ...
    expect(text).toContain('$108.00')
    expect(text).toContain('100.00 coins')
    expect(text).toContain('20.00 coins')
    expect(text).toContain('80.00 coins')
    expect(text).toContain('200.00 coins')
  })
