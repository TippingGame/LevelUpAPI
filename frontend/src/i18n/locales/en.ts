export default {
  ...
  userAccounts: {
    ...
    importWarningOpenAI: 'You can import up to {max} OpenAI accounts. Free / Plus / Team support JSON or Refresh Tokens; Pro must use account login.',
    ...
    importAccountLevelHint: 'Required only for OpenAI imports. OpenAI imports are checked strictly against the selected level; unconfirmed accounts are treated as Free; Pro must use account login.',
    ...
    importOAuthOnlyHint: 'This level can only be imported through OpenAI account login. Select a proxy IP, generate the login URL, then paste the callback result.',
    importOAuthNamePlaceholder: 'Optional; OpenAI email is used when blank',
    importProxy: 'Proxy IP',
    importProxyHint: 'Select a visible active proxy IP for generating the login URL and exchanging the authorization code.',
    ...
    importTextHintOpenAI: 'OpenAI Free / Plus / Team can import OAuth JSON or Refresh Tokens; Pro must use account login.',
