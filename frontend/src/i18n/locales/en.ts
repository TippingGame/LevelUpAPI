export default {
  ...
  store: {
    ...
    description: 'Browse available card products, pay with balance or an enabled platform payment method, and receive delivery after purchase.',
  ...
  admin: {
    ...
    users: {
      ...
      concurrencyRange: 'User concurrency must be between 1 and 5',
      concurrencyRangeHint: 'Personal users can use 1-5 concurrent requests.',
