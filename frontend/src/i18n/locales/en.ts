export default {
  ...
  home: {
    ...
    arcade: {
      ...
      stepsTitleAfterSteps: ' steps to start, ',
      stepsTitleAfterMinutes: ' minutes to migrate',
      steps: {
        register: {
          title: 'Create account',
          desc: 'Sign up free and receive starter credits instantly'
        },
        apiKey: {
          title: 'Get an API Key',
          desc: 'Generate keys in one click with multi-key management and access control'
        },
        baseUrl: {
          title: 'Replace Base URL',
          desc: 'Point your client here and finish migration fast'
        }
      }
    },
  ...
  auth: {
    ...
    promoCodeValid: 'Valid! You will receive {amount} coins bonus balance',
    ...
    invitationCodeExpired: 'Invitation code has expired. Please use the new invite link',
    invitationCodeQuotaExhausted: 'This invitation code has no weekly uses left',
  ...
  userAccounts: {
    ...
    loadFactorCreditsPreview: 'Paid ceiling {paid}, cost now {cost}, remaining {balance}',
    loadFactorCreditsInsufficient: 'Insufficient load-factor credits',
    bulkLoadFactorCreditsHint: 'Bulk changes debit credits per account based on each paid ceiling. Lowering does not refund.',
    ...
    importWarning: 'You can import up to {max} accounts at a time. Supported: Sub2API OAuth JSON, Codex-Manager ChatGPT token JSON, OpenAI Refresh Token, and Claude Session Key. API keys, URLs, upstream endpoints and cookies are rejected.',
    importWarningChoosePlatform: 'Select the import platform first. You can import up to {max} accounts at a time. API keys, URLs, upstream endpoints and cookies are rejected.',
    importWarningOpenAI: 'You can import up to {max} OpenAI accounts. Free / Plus / Team can import directly; Pro can use bulk credential import or account login, but must select a proxy IP.',
    importWarningClaude: 'You can import up to {max} Claude accounts. Supports Sub2API OAuth JSON or Claude Session Key.',
    importWarningGemini: 'You can import up to {max} Gemini accounts. Only official OAuth JSON with Gemini platform metadata is accepted.',
    importWarningAntigravity: 'You can import up to {max} Antigravity accounts. Only official OAuth JSON with Antigravity platform metadata is accepted.',
    importWarningGrok: 'You can import up to {max} Grok accounts. Explicitly choose OAuth JSON, Refresh Token, or Web SSO; these credential formats are never mixed.',
    ...
    importPlatformHintClaude: 'Claude imports do not use OpenAI account levels. Use Claude OAuth JSON or Claude Session Key.',
    importPlatformHintGemini: 'Gemini imports do not use OpenAI account levels. Import OAuth JSON containing platform: gemini.',
    importPlatformHintAntigravity: 'Antigravity imports do not use OpenAI account levels. Import OAuth JSON containing platform: antigravity.',
    importPlatformHintGrok: 'Grok uses official xAI OAuth and requires a visible proxy. Web SSO is converted through the xAI Device Flow and the original SSO value is never stored.',
    importGrokMethod: 'Grok Import Method',
    importGrokMethodOAuth: 'OAuth JSON',
    importGrokMethodOAuthHint: 'Import account JSON containing access_token and platform: grok.',
    importGrokMethodRefreshToken: 'Refresh Token',
    importGrokMethodRefreshTokenHint: 'One xAI refresh token per line; validate and create accounts.',
    importGrokMethodSSO: 'Web SSO',
    importGrokMethodSSOHint: 'One Grok Web SSO key per line; convert to Build OAuth.',
    importAccountLevel: 'OpenAI Account Level',
    importAccountLevelHint: 'Required only for OpenAI imports. OpenAI imports are checked strictly against the selected level; unconfirmed accounts are treated as Free; Pro must select a proxy IP.',
    ...
    importLevelPro: 'Requires a proxy IP',
    importLevelTeam: 'Supports JSON import and only accepts actual Team accounts',
    importShareModeHint: 'Public import validates the account, public pool group, and revenue-share policy after creation. Passing accounts are bound to the public group; failed accounts keep the private default group and show the reason.',
    importMethod: 'Pro Import Method',
    importMethodCredentials: 'Bulk Credentials',
    importMethodCredentialsHint: 'Paste JSON or Refresh Tokens; all imported accounts use the selected proxy.',
    importMethodOAuth: 'Account Login',
    importMethodOAuthHint: 'Generate a login URL and complete one OpenAI authorization.',
    ...
    importProxyHint: 'Select a visible active proxy IP for login or import flows that need one. OpenAI Pro / Claude / Gemini / Antigravity / Grok require it.',
    ...
    proxySmartPlaceholder: "Example:\n192.168.0.1:8000:username:password\nusername:password{'@'}192.168.0.1:8000",
    proxySmartApply: 'Parse into form',
    proxySmartHint: 'Supports socks5/http/https URLs, credential-first format, and colon-separated format.',
    proxyName: 'Proxy name',
    proxyNamePlaceholder: 'Example: Roxy dedicated IP / residential proxy',
    proxyNameHint: 'Used to identify this proxy in the selector. Only visible to you. Blank names are generated from host and port.',
    ...
    proxyInvalidFormat: 'Unable to parse proxy format. Check host, port, username and password.',
    ...
    importOAuthCallbackRequired: 'Generate the login URL first, then paste an OpenAI callback containing code and state',
    ...
    importTextHintChoosePlatform: 'Select a platform first, then paste OAuth credentials for that platform.',
    importTextHintOpenAI: 'OpenAI Free / Plus / Team can import OAuth JSON or Refresh Tokens; Pro can also import, but must select a proxy IP.',
    importTextHintClaude: 'Claude can import Claude Session Keys or OAuth JSON with Anthropic/Claude platform metadata.',
    importTextHintGemini: 'Gemini only accepts OAuth JSON with Gemini platform metadata; plain tokens are not accepted.',
    importTextHintAntigravity: 'Antigravity only accepts OAuth JSON with Antigravity platform metadata; plain tokens are not accepted.',
    importTextHintGrokOAuth: 'Only Grok OAuth JSON is parsed. Include platform: grok and access_token; plain text is never guessed as another provider.',
    importTextHintGrokRefreshToken: 'Enter one xAI Refresh Token per line. Each token is validated through the selected proxy and failures are reported individually.',
    importTextHintGrokSSO: 'Enter one Grok Web SSO key per line. The server completes the xAI Device Flow with 3-way concurrency; original SSO values are never written to accounts, logs, or responses.',
  ...
  keys: {
    ...
    imagePlaygroundUnavailable: 'Feature not available yet',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
    ...
    choosePlatformFirst: 'Available pools will appear after you select a platform',
    selectedGroupCount: '{count} selected',
    clearSelection: 'Clear',
    saveSelection: 'Save',
    samePlatformOnly: 'Only pools from the same platform can be selected',
    privateGroupDescription: 'Private {platform} subscription pool for user {userId}.',
    privateGroupDescriptionWithoutOwner: 'Private {platform} subscription pool.',
    statusLabel: 'Status',
    ...
    quotaAmount: 'Quota Amount (coins)',
    quotaAmountPlaceholder: 'Enter quota limit in coins',
    ...
    resetQuotaConfirmMessage: 'Are you sure you want to reset the used quota ({used} coins) for key "{name}" to 0? This action cannot be undone.',
    quotaResetSuccess: 'Quota reset successfully',
    failedToResetQuota: 'Failed to reset quota',
    rateLimitColumn: 'Rate Limit',
    rateLimitSection: 'Rate Limit',
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (coins)',
    rateLimit1d: 'Daily Limit (coins)',
    rateLimit7d: '7-Day Limit (coins)',
  ...
  affiliate: {
    ...
    weeklyQuota: 'Invite Limit',
    weeklyQuotaText: '{remaining} left ({used} used / {limit} limit)',
    weeklyQuotaUnlimited: 'Unlimited invitees ({used} used this week)',
    codePolicy: {
      title: 'Code Policy',
      rotateWeekly: 'Rotates every Monday at 00:00',
      keepCode: 'Invite code stays unchanged',
  ...
  admin: {
    ...
    revenue: {
      ...
      fields: {
        ...
        balanceGtPointOneWithPendingWithdrawal: 'User Balance > 0.1 + Pending Withdrawal Balance',
      ...
      shareSettlements: {
        ...
        errors: {
          ...
          REVENUE_EXPORT_ALREADY_RUNNING: 'An export task is already pending or running',
          REVENUE_EXPORT_TOO_LARGE: 'Export result exceeds 1,000,000 rows. Narrow the date range or filters',
          REVENUE_EXPORT_TASK_NOT_FOUND: 'Export task was not found or is not accessible',
          ...
          REVENUE_EXPORT_EXPIRED: 'Export file has expired. Please export again',
          REVENUE_EXPORT_FILE_MISSING: 'Export file is missing. Please export again'
        }
      }
    },
    ...
    users: {
      ...
      invitePolicy: {
        ...
        description: "Adjust this user's invite code, weekly uses, and rotation policy.",
        codeLabel: 'Current Invite Code',
        codeHint: 'After changing it, the new code is used immediately and the old code can no longer register users.',
        codeRequired: 'Invite code cannot be empty',
        weeklyLimitLabel: 'Weekly Uses',
        weeklyLimitHint: 'Default is unlimited. Set a value greater than 0 to enable a weekly limit.',
        autoRotateLabel: 'Enable Weekly Auto-Rotation',
        ...
        weeklyUsageUnlimited: 'Used this week {used} / unlimited',
        remaining: '{remaining} remaining',
        remainingUnlimited: 'Unlimited invitees'
      },
      columns: {
        user: 'User',
        id: 'ID',
    ...
    groups: {
      ...
      subscription: {
        ...
        dailyLimit: 'Daily Limit (coins)',
        weeklyLimit: 'Weekly Limit (coins)',
        monthlyLimit: 'Monthly Limit (coins)',
    ...
    riskControl: {
      ...
      cyberPreflightHint: 'Uses local high-risk cyber abuse rules to block hits before account selection; the global risk-control switch must also be enabled.',
      mode: 'Global Mode',
      ...
      providerOpenAIHint: 'Uses OpenAI Moderations category scores and configured thresholds.',
      providerZhipu: 'Zhipu Content Safety',
      providerZhipuHint: 'Uses Zhipu moderation with PASS / REVIEW / REJECT. Text is reviewed in 2000-character chunks.',
      ...
      zhipuImageUnsupported: 'Zhipu image moderation is not implemented yet. Text moderation is supported.',
      ...
      cyberRules: {
        notice: 'One rule per line. Saved rules are evaluated locally before account selection; clearing a group disables that group.',
        placeholder: 'One rule per line',
        count: '{count}',
        resetDefaults: 'Restore Defaults',
        standaloneBlockMarkers: 'Standalone high-risk blocks',
        standaloneBlockMarkersHint: 'Directly blocks very high-risk phrases such as AV bypass, phishing pages, or keyloggers.',
        hardMarkers: 'High-risk technical markers',
        hardMarkersHint: 'Blocks only when combined with offensive intent or a real target to reduce false positives.',
        offensiveIntentMarkers: 'Offensive intent markers',
        offensiveIntentMarkersHint: 'Combined with high-risk or technique markers, such as generate, attack, bypass, exploit.',
        credentialAbuseIntentMarkers: 'Credential abuse intent',
        credentialAbuseIntentMarkersHint: 'Combined with credential markers, such as harvest, export, steal, or leak.',
        techniqueMarkers: 'Offensive technique markers',
        techniqueMarkersHint: 'Combined with offensive intent or real targets, such as injection, RCE, brute force, scanning.',
        credentialMarkers: 'Credential markers',
        credentialMarkersHint: 'Combined with abuse intent, such as token, cookie, password, secret key.',
        targetMarkers: 'Real-target markers',
        targetMarkersHint: 'Combined with high-risk or technique markers, such as public internet, production, admin, login.',
        defensiveMarkers: 'Defensive / authorized allow markers',
        defensiveMarkersHint: 'Reduces false positives, such as detect, patch, defense, authorized test, lab, CTF.',
      },
    ...
    accounts: {
      ...
      quotaDashboard: {
        ...
        issueMeta: 'Limited {limited}, quota protected {protected}, error {error}, disabled {disabled}',
      ...
      credentialImportHint: 'Paste account credentials or import files. Admin credential import validates and creates OAuth accounts for the matching platform.',
      credentialImportWarning: 'This entry accepts official OAuth credentials: Sub2API OAuth JSON, Grok OAuth JSON, Refresh Token JSON with platform: grok, Codex-Manager ChatGPT token JSON, OpenAI Refresh Token, and Claude Session Key. API keys, custom URLs, upstream endpoints, and cookies are rejected. Admins can create Grok API-key accounts through Add Account.',
      ...
      dataImportHint: 'Upload an exported account/proxy bundle or account credential JSON. Grok OAuth JSON and Refresh Token JSON with platform: grok are supported.',
      dataImportWarning: 'Bundles create new accounts/proxies, while credential JSON is validated and creates OAuth accounts. Groups must be bound manually; ensure existing data does not conflict.',
      ...
      dataImportMixedFormats: 'Data exports and account credential files cannot be mixed in one batch',
      dataImportIgnoredFiles: 'Ignored {count} non-JSON file(s)',
      dataImportSelectedCount: '{count} files selected',
      dataImportDropHint: 'Select or drop multiple JSON files',
      ...
      quotaLimitHint: 'Set daily/weekly/total spending limits (coins). Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
          ...
          authCodePlaceholder:
            'Option 1: Copy the complete URL\n(http://localhost:xxx/auth/callback?code=...)\nOption 2: Copy only the code parameter value',
                  ...
                  grok: {
                    ...
                    oauthOnlyHint: 'User-owned Grok accounts support official xAI OAuth only, require an owned/visible proxy, and have concurrency fixed at 1.',
                    ...
                    ssoCookieAuth: 'Web SSO Import',
                    ssoCookieDesc: 'Paste one Grok Web SSO key per line. The server completes the xAI Device Flow and converts it into official Build OAuth credentials.',
                    ssoCookieLabel: 'Grok Web SSO Key',
                    ssoCookiePlaceholder: 'One SSO key per line\nAlso accepts sso=... or a full Cookie header',
                    ssoCookieHint: 'Conversions run with 3-way concurrency. Use a matching-region proxy when needed; original SSO values are never stored.',
                    convertingSSO: 'Converting...',
                    convertSSOAndCreate: 'Convert & Create Accounts',
                    validating: 'Validating...',
                    validateAndCreate: 'Validate & Create',
                    pleaseEnterRefreshToken: 'Please enter Refresh Token',
                    failedToValidateRT: 'Failed to validate Grok Refresh Token',
                    failedToConvertSSO: 'Failed to convert Grok Web SSO',
                    errors: {
      ...
      openaiQuotaReset: {
        ...
        confirmMessage: 'This will consume 1 OpenAI reset credit for "{name}". Current available credits: {count}. Continue?',
    ...
    proxies: {
      ...
      maxAccountsHint: 'Limits how many accounts can bind to this IP. 0 means no binding limit.',
      ...
      maxAccountsInvalid: 'Account binding limit must be an integer greater than or equal to 0',
      maxAccountsBelowCurrent: 'This proxy already has {current} bound accounts. The limit cannot be lower than the current count unless set to 0',
      deleteConfirm:
    ...
    promo: {
      ...
      bonusAmount: 'Bonus Amount (coins)',
      maxUses: 'Max Uses',
    ...
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Configure SLA, TTFT, and error-rate thresholds used by ops health checks.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'Service quality is treated as abnormal when SLA drops below this percentage.',
        ttftP99MaxMs: 'Max TTFT P99 (ms)',
        ttftP99MaxMsHint: 'Show performance risk when first-token latency P99 exceeds this value.',
        requestErrorRateMaxPercent: 'Max Request Error Rate (%)',
        requestErrorRateMaxPercentHint: 'Show risk when client request error rate exceeds this value.',
        upstreamErrorRateMaxPercent: 'Max Upstream Error Rate (%)',
        upstreamErrorRateMaxPercentHint: 'Show risk when upstream error rate exceeds this value.',
    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          ...
          cyberSessionBlockEnabledHint: 'After upstream returns cyber_policy, later requests in the same explicit session are blocked before account selection. Disabled by default.',
          cyberSessionBlockTTL: 'Session block TTL (seconds)',
          cyberSessionBlockTTLHint: '3600 seconds is recommended. Applies only to session_id, conversation_id, or prompt_cache_key.',
        },
        affiliate: {
          title: 'Invite Income',
      ...
      security: {
        upstreamAllowlist: {
          ...
          description: 'Additional hosts or direct IP endpoints allowed as account Base URLs. Hosts from the config file remain allowed.',
          ...
          invalid: 'Invalid upstream allowlist. Use hosts, *.example.com wildcard hosts, IPs, or IP:port entries.'
        }
      },
      turnstile: {
      ...
      defaults: {
        ...
        defaultAffiliateWeeklyLimit: 'Invite Weekly Uses',
        defaultAffiliateWeeklyLimitHint: 'Weekly uses for new users affiliate invite codes; 0 = unlimited. Only applied when a new affiliate profile is created.',
        defaultAffiliateCodeAutoRotate: 'Weekly Auto-Rotate Code',
        defaultAffiliateCodeAutoRotateHint: 'When enabled, new users invite codes rotate on each weekly cycle. When disabled, codes remain stable.',
        ...
        privateGroupDailyLimit: 'Daily Limit coins',
        privateGroupWeeklyLimit: 'Weekly Limit coins',
        privateGroupMonthlyLimit: 'Monthly Limit coins',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptInjectionHint: 'Inject configurable Claude Code-like system blocks for non-Claude Code clients using Claude OAuth accounts.',
        ...
        anthropicCacheTTL1hInjectionHint: 'When enabled, existing ephemeral cache_control blocks in Anthropic OAuth/Setup Token request bodies are forced to 1h; response usage is billed from the upstream 5m/1h breakdown by default, with account-level TTL billing override taking priority.',
        ...
        clientDatelineNormalizationHint: 'On by default. Cleans steganographic date variants only in system-reminder lines for Anthropic OAuth/Setup Token requests, without touching normal user text or API Key accounts.',
      },
      webSearchEmulation: {
      ...
      payment: {
        ...
        tabVisibilityHint: 'When disabled, the corresponding tab and content are hidden from the user payment page.',
        ...
        balanceRechargeMultiplierHint: 'How many coins balance the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = {usd} coins',
        ...
        announcementPlaceholder: 'Enter the announcement shown when users open Recharge / Subscription...',
        announcementHint: 'Shown at the top of the user Recharge / Subscription page. Leave empty to hide it.',
        rechargeCenterTitle: 'Recharge Center',
        rechargeCenterHint: 'Configure external entries on the user Recharge / Subscription page. Links open in a new window by default.',
        ...
        rechargeCenterDescriptionPlaceholder: 'e.g. Supports quick Alipay and WeChat top-ups',
        ...
        rechargeCenterUrlInvalid: 'Recharge center entry link must be a valid absolute http(s) URL.',
        helpText: 'Help Text',
        ...
        receiptCodeOssHint: 'Stores user withdrawal receipt code images in S3 / OSS / COS compatible object storage.',
      ...
      receiptCode: {
        title: 'Receipt Code Storage',
        description: 'Configure object storage for shared owners withdrawal receipt code images. Settings are stored in the database and the secret is encrypted, so .env maintenance is no longer required.',
        storageEnabled: 'Enable receipt code object storage',
        storageEnabledHint: 'When enabled, shared owners can upload Alipay or WeChat receipt codes from their profile.',
        endpoint: 'Endpoint',
        region: 'Region',
        bucket: 'Bucket',
        accessKey: 'AccessKey ID / SecretId',
        secretKey: 'AccessKey Secret / SecretKey',
        prefix: 'Object Prefix',
        publicBaseUrl: 'Public Base URL',
        publicBaseUrlHint: 'Usually leave blank. The system will use temporary signed URLs for private objects.',
        maxSize: 'Max Image Size (bytes)',
        presignExpire: 'Signed URL Expiry (seconds)',
        forcePathStyle: 'Use path-style requests',
        secretConfiguredPlaceholder: 'Already configured, leave blank to keep',
        storageNote: 'For Tencent COS, use an endpoint like https://cos.ap-guangzhou.myqcloud.com, region ap-guangzhou, and the full bucket name with APPID. Keep the bucket private and use a dedicated prefix for receipt codes.',
      },
      balanceNotify: {
        title: 'Balance Low Notification',
      ...
      openaiFreeAccountRepair: {
        ...
        threshold: 'Free detection weekly limit threshold (coins)',
        thresholdHint: 'For example, 60 triggers repair when weekly limit is less than or equal to 60 coins and 7-day usage reaches 100%.'
      },
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupMultiplier: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the billing multiplier to control user charges.</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ Billing Rules:</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - Original price (cost price)</li><li><b>1.5</b> - User consumes 1 coins, charged 1.5 coins</li><li><b>2.0</b> - User consumes 1 coins, charged 2 coins</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p style="font-size: 13px; color: #6b7280;">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
  ...
  payment: {
    ...
    airwallexMissingParams: 'Missing Airwallex payment parameters. Please go back and start payment again.',
    ...
    rechargeRatePreview: 'Current rate: 1 CNY = {coins} coins',
    ...
    admin: {
      ...
      insufficientBalance: 'Insufficient balance — will deduct to 0 coins',
  ...
  agentExperience: {
    ...
    subtitle: 'Choose your API key and model for a focused Q&A experience in the browser',
    qaMode: 'Q&A Mode',
    ...
    newChat: 'New Chat',
    createKey: 'Create API Key',
    promptExplain: 'Explain a complex technical concept',
    promptPlan: 'Help me plan a project implementation',
    promptWrite: 'Write a clear and reliable code example',
    preparing: 'Preparing your online experience',
    noKeyTitle: 'Create an API key first',
    noKeyDescription: 'The online experience uses a key created on this site, with no copying or manual entry required.',
    chooseModelTitle: 'Choose a model to begin',
    chooseModelDescription: 'Available models are loaded automatically for the selected key.',
    readyTitle: 'What would you like to explore?',
    readyDescription: 'This is LevelUpAgent’s browser Q&A mode, with streaming answers and Markdown rendering.',
    ...
    emptyResponse: 'The model returned no displayable content. Please try again.',
