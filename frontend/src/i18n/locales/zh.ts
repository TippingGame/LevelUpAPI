export default {
  ...
  userAccounts: {
    ...
    importWarningOpenAI: '单次最多导入 {max} 个 OpenAI 账号。Free / Plus / Team 支持 JSON 或 Refresh Token；Pro 必须通过账号登录导入。',
    ...
    importAccountLevelHint: '仅导入 OpenAI 账号时需要选择。OpenAI 会按所选等级严格校验；无法确认等级时按 Free 处理；Pro 必须通过账号登录导入。',
    ...
    importOAuthOnlyHint: '当前等级只能通过 OpenAI 账号登录导入。请先选择代理 IP，再生成登录链接并粘贴回调结果。',
    importOAuthNamePlaceholder: '可选；留空则使用 OpenAI 邮箱',
    importProxy: '代理 IP',
    importProxyHint: '请选择一个可见且启用的代理 IP，用于生成登录链接和兑换授权码。',
    ...
    importTextHintOpenAI: 'OpenAI Free / Plus / Team 可粘贴 OAuth JSON 或 Refresh Token；Pro 请通过账号登录导入。',
